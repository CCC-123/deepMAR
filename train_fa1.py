...
def checkpoint(epoch):
    if not os.path.exists("checkpoint2.1"):
        os.mkdir("checkpoint2.1")
    path = "./checkpoint2.1/checkpoint_epoch_{}".format(epoch)
...
net.load_state_dict(net_dict) ''' #shabi sequential

historyPath = "./checkpoint2.1/checkpoint_epoch_990" 
net = models.alexnet(num_classes=35)
...
optimizer = torch.optim.SGD([{'params':net.features.parameters()},
                            {'params':net.classifier.parameters(),'lr':0.001}], lr=0.0001, momentum=0.9)
